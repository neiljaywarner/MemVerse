...
import com.spiritflightapps.memverse.debug.R
 ...
 * [VerseFragment.OnListFragmentInteractionListener] interface.
 */
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyVerseRecylerAdapter(DummyContent.ITEMS, listener)
            }
        }
        return view
    }
