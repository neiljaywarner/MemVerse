...
object Analytics {
    ...
    fun trackEvent(eventName: String, verse: Verse) {
        // TODO: create verse.getRef method
    }

    fun trackEvent(eventName: String, ref: String) {
        trackEvent(eventName, hashMapOf(Pair("ref", ref)))
    }
